...
const ChatForm = ({ socket, onNewMessage }) => {
    const [username] = useState(localStorage.getItem("loggedInUser"));
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // await axios.post('http://localhost:5000/postchat', {
            //     username,
            //     message,
            // }, { headers });

            // Emit the new message to the server via Socket.io
            socket.emit('newMessage', { username, message },{headers});
            console.log("the newmessage socket is emitted....")
